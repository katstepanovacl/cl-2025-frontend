...
const Card = ({
  ...
  return (
    <div className={cn(cardVariants({ variant }))} {...props}>
      <div className="w-content lg:w-1/2 h-full mx-auto">
        <Image src={cardImage} alt={alt} />
      </div>
      <div className="flex flex-col gap-10 w-content lg:w-1/2 h-full">
        <div className="flex flex-col gap-4">
          <p className="uppercasetext-brown font-playfair text-[28px] leading-[36px] tracking-[0.5px] font-bold">
            {title}
          </p>
